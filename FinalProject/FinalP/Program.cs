...
namespace ConsoleApplication4
{
    ...
    class Multitude
    {
        ...
        public static Multitude operator+(Multitude first_mult, Multitude second_mult)
        {
            Multitude resSet = new Multitude();
            resSet.Union(first_mult, second_mult);
            return resSet;
        }
        public static Multitude operator-(Multitude first_mult, Multitude second_mult)
        {
            Multitude resSet = new Multitude();
            resSet.Difference(first_mult, second_mult);
            return resSet;
        }
        public static Multitude operator*(Multitude first_mult, Multitude second_mult)
        {
            Multitude resSet = new Multitude();
            resSet.Intersection(first_mult, second_mult);
            return resSet;
        }
    }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Multitude A1 = new Multitude();
            Multitude A2 = new Multitude();
            A1 = A + B;
            A2 = A1 * (C - B);
